    ...
    <>
      <main className="max-w-7xl mx-auto w-full px-6">
        <div className="hero grid w-full md:grid-cols-2 items-center pt-16 md:pt-24 lg:pt-28 pb-14 md:pb-20 xl:gap-16 gap-12 grid-cols-1">
          ...
          <Reveal variant="scale" delay={160} duration={600} className="flex justify-center md:justify-end -translate-y-4 md:-translate-y-10">
            <ProfileCard
              name="Cruz"
        ...
        {/* About */}
        <div
          className="section-gap w-full rounded-3xl border-[5px] border-violet-500/40 shadow-[0_0_30px_rgba(168,85,247,0.4)] bg-gradient-to-br from-[#0a0a0a] via-[#111111] to-[#1a1a1a] px-5 py-8 md:px-6 md:py-10"
          id="about"
        >
          <div className="grid grid-cols-1 md:grid-cols-2 items-stretch gap-8 md:gap-10 px-4 md:px-6">
            <div className="flex items-center pr-0 md:pr-10 border-b md:border-b-0 md:border-r border-violet-500/30 pb-8 md:pb-0">
              <div className="w-full text-left">
                ...
                <div className="flex flex-col sm:flex-row items-center sm:items-start sm:justify-between text-center sm:text-left gap-y-5 sm:gap-y-0 mb-6 w-full">
                  <Reveal variant="up" delay={140} duration={500} className="w-full sm:flex-1">
                    <h1 className="text-2xl md:text-3xl mb-1">
                      6<span className="text-violet-500">+</span>
                    </h1>
                    <p className="text-sm">Projects Completed</p>
                  </Reveal>
                  <Reveal variant="up" delay={200} duration={500} className="w-full sm:flex-1">
                    <h1 className="text-2xl md:text-3xl mb-1">
                      1st<span className="text-violet-500"> Year</span>
                    </h1>
                    <p className="text-sm">Computer Science Student</p>
                  </Reveal>
                  <Reveal variant="up" delay={260} duration={500} className="w-full sm:flex-1">
                    <h1 className="text-2xl md:text-3xl mb-1">
            ...
            <Reveal variant="scale" delay={120} duration={650} className="min-w-0 pl-0 md:pl-10 overflow-hidden max-w-full flex items-center justify-center">
        ...
        <div className="tools section-gap w-full overflow-x-hidden">
          ...
          <Reveal as="p" variant="up" delay={80} duration={500} className="w-2/5 text-sm md:text-base opacity-50">
        ...
        {/* Project */}
        <div className="project section-gap w-full" id="project" />
        ...
        <Reveal
          ...
          delay={80}
          duration={500}
          className="text-sm md:text-base text-center opacity-50"
        >
        ...
        <div className="project-box mt-10 w-full bg-transparent">
          <div className="relative h-auto bg-transparent">
            <InViewLazy>
